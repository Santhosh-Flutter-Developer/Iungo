...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'pr_stage': 'Stage',
      'pr_print': 'Print',
      'pr_pdf_unavailable': 'PDF is not available for this request.',
      ...
      'pr_load_failed': 'Unable to load purchase requests. Please try again.',
      'pr_approve_failed': 'Could not approve the purchase request.',
      'pr_reject_failed': 'Could not reject the purchase request.',
      'pr_no_items': 'No items found.',
      'pr_no_pipeline': 'No approval pipeline available for this request.',
      'pr_select_attachment': 'Select Attachment',
      'pr_select_attachment_hint': 'Select one attachment to approve with.',
      'pr_select_one_attachment': 'Please select one attachment before approving.',
      'pr_select_only_one_attachment':
          'Please select only one attachment before approving.',
      'pr_remarks_required_reject':
          'Please enter remarks before rejecting the purchase request.',
      'pr_remarks_too_long': 'Remarks cannot exceed 250 characters.',
    },
    'ar_SA': {
      'app_name': 'Iungo',
      'powered_by': 'Powered by CIT',
      ...
      'pr_stage': 'المرحلة',
      'pr_print': 'طباعة',
      'pr_pdf_unavailable': 'ملف PDF غير متاح لهذا الطلب.',
      ...
      'pr_invoice': 'الفاتورة',
      'pr_purchase_request': 'طلب الشراء',
      'pr_load_failed': 'تعذر تحميل طلبات الشراء. يرجى المحاولة مرة أخرى.',
      'pr_approve_failed': 'تعذرت الموافقة على طلب الشراء.',
      'pr_reject_failed': 'تعذر رفض طلب الشراء.',
      'pr_no_items': 'لا توجد عناصر.',
      'pr_no_pipeline': 'لا يوجد مسار موافقات لهذا الطلب.',
      'pr_select_attachment': 'اختر مرفقًا',
      'pr_select_attachment_hint': 'اختر مرفقًا واحدًا للموافقة.',
      'pr_select_one_attachment': 'يرجى اختيار مرفق واحد قبل الموافقة.',
      'pr_select_only_one_attachment': 'يرجى اختيار مرفق واحد فقط قبل الموافقة.',
      'pr_remarks_required_reject': 'يرجى إدخال الملاحظات قبل رفض طلب الشراء.',
      'pr_remarks_too_long': 'لا يمكن أن تتجاوز الملاحظات 250 حرفًا.',
    },
  };
}