...
/// code/description, remarks, quantity/unit price/total), followed by
/// the same Financial Breakdown card shown on Summary.
class PrSupplyItemsTab extends StatelessWidget {
  const PrSupplyItemsTab({super.key, required this.request});
