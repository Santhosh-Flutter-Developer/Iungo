...
/// "Awaiting Approval for Closure" search screen. Mirrors
/// [WorkOrderSearchPage] ("All Work Orders" search) exactly — same
/// layout, scope dropdown, and idle/loading/results/no-results states.
class WorkOrderClosureApprovalSearchPage
    extends GetView<WorkOrderClosureApprovalSearchController> {
  const WorkOrderClosureApprovalSearchPage({super.key});
...
class _SearchAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  final WorkOrderClosureApprovalSearchController controller;
