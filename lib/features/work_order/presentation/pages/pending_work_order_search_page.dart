...
/// Search screen for "Awaiting for Pause Approval" / "Awaiting Approval for
/// Closure". Deliberately identical UI to [WorkOrderSearchPage] — white app
...
class PendingWorkOrderSearchPage extends StatelessWidget {
  const PendingWorkOrderSearchPage({super.key, required this.kind});
  ...
  Widget build(BuildContext context) {
    final controller =
        Get.find<PendingWorkOrderSearchController>(tag: kind.tag);
        ...
        child: Obx(() {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) => WorkOrderCard(
              workOrder: controller.results[index],
              onTap: () => Get.to(
...
class _SearchAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  final PendingWorkOrderSearchController controller;
