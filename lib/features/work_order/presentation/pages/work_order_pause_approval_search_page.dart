...
/// "Awaiting for Pause Approval" search screen. Mirrors
/// [WorkOrderClosureApprovalSearchPage] exactly — same layout, scope
/// dropdown, and idle/loading/results/no-results states.
class WorkOrderPauseApprovalSearchPage
    extends GetView<WorkOrderPauseApprovalSearchController> {
  const WorkOrderPauseApprovalSearchPage({super.key});
...
class _SearchAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  final WorkOrderPauseApprovalSearchController controller;
