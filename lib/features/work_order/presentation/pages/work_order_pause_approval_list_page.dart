...
/// "Awaiting for Pause Approval" screen. Deliberately mirrors
/// [WorkOrderClosureApprovalListPage] exactly — same UI, spacing,
/// pagination, search, filter, refresh, and Detail View navigation —
/// backed by the `awaitingforpauseworkorders` view API instead of
/// `awaitingapprovalforclousre`.
class WorkOrderPauseApprovalListPage extends StatefulWidget {
  const WorkOrderPauseApprovalListPage({super.key});

  @override
  State<WorkOrderPauseApprovalListPage> createState() =>
      _WorkOrderPauseApprovalListPageState();
}

class _WorkOrderPauseApprovalListPageState
    extends State<WorkOrderPauseApprovalListPage> {
  final WorkOrderPauseApprovalListController controller =
      Get.find<WorkOrderPauseApprovalListController>();
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () => Get.to(
              () => const WorkOrderPauseApprovalSearchPage(),
              binding: WorkOrderPauseApprovalSearchBinding(),
            ),
          ),
        ],
      ),
      drawer: const AppDrawer(selected: DrawerMenuItem.awaitingPauseApproval),
      body: SafeArea(
        child: Column(
          children: [
            Padding(
