...
/// "Awaiting Approval for Closure" search screen controller. Mirrors
/// [WorkOrderSearchController] ("All Work Orders" search) exactly — same
/// debounce, scope handling, and client-side narrowing — backed by
/// [WorkOrderClosureApprovalRepository] instead of the shared "All Work
/// Orders" repository.
class WorkOrderClosureApprovalSearchController extends GetxController {
  WorkOrderClosureApprovalSearchController(this._repository);
  ...
  /// Hits the server's `view/awaitingapprovalforclousre` API.
  ///
