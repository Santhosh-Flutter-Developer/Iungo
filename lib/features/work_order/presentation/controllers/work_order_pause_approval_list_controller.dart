...
/// Drives the "Awaiting for Pause Approval" screen. Mirrors
/// [WorkOrderListController] ("All Work Orders") exactly — same
/// pagination, search, filter, refresh, and error-handling behavior —
/// backed by [WorkOrderPauseApprovalRepository] instead of the shared
/// "All Work Orders" repository.
class WorkOrderPauseApprovalListController extends GetxController
    implements WorkOrderFilterControllerLike {
  WorkOrderPauseApprovalListController(this._repository);
