...
/// "My Service Requests". White app bar with an inline text field, a
/// field-scope dropdown ("All Fields" / "Ticket Id"), and a close icon.
/// Body cycles through: idle prompt -> debounce spinner -> results list
/// or "No Results Found".
        ...
        child: Obx(() {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) =>
                ServiceRequestCard(request: controller.results[index]),
          );
        }),
      ),
    );
...
class _SearchAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  final TicketSearchController controller;
