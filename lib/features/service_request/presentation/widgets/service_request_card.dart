...
import 'package:iungo/features/service_request/presentation/bindings/service_request_detail_binding.dart';
import 'package:iungo/features/service_request/presentation/pages/service_request_detail_page.dart';
...
/// requester / site / priority. Tapping the card opens the Detail View.
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => Get.to(
        ...
        binding: ServiceRequestDetailBinding(request),
      ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  _InfoItem(
                    ...
                    label:
                        request.priority == ServiceRequestPriority.noPriority
