...
/// Summary tab of the GRN Detail View — General Specification fields,
/// the Financial Breakdown card, and the quotation attachment (if any).
/// Mirrors `PrSummaryTab` shape for shape.
class GrnSummaryTab extends StatelessWidget {
  const GrnSummaryTab({super.key, required this.request});
