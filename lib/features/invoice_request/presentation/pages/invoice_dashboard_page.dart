...
/// `GrnDashboardPage`'s chrome/refresh/filter/search flow exactly,
            ...
            Expanded(
              child: Obx(() {
                ...
                if (controller.hasError.value) {
                  return _InvoiceErrorState(onRetry: controller.reload);
                }
                      ...
                      return Obx(() {
                        ...
                        return InvoiceRequestCard(
                          ...
                          onTap: () => Get.to(
                            ...
                            binding: InvoiceDetailBinding(request),
...
class _InvoiceErrorState extends StatelessWidget {
  const _InvoiceErrorState({required this.onRetry});
