      ...
      body: SafeArea(
        ...
        child: Obx(() {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) => InvoiceRequestCard(
...
class _SearchAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  final InvoiceSearchController controller;
    ...
    return AppBar(
      ...
      title: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'invoice_search_hint'.tr,
...
class _ScopeDropdownButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return PopupMenuButton<InvoiceSearchScope>(
      icon: const Icon(Icons.sort, color: Colors.grey),
      offset: const Offset(0, 40),
      color: AppColors.white,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(4)),
      onSelected: controller.onScopeChanged,
      itemBuilder: (context) => InvoiceSearchScope.values
          .map(
            (item) => PopupMenuItem<InvoiceSearchScope>(
              value: item,
              child: _ScopeMenuRow(
                scope: item,
...
class _ScopeMenuRow extends StatelessWidget {
  ...
  final InvoiceSearchScope scope;
  final bool selected;
