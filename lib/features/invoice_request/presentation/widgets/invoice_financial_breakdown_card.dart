...
/// Total" breakdown card — shown on every tab of the Invoice Detail
/// View, matching the reference screenshots. Mirrors
/// `GrnFinancialBreakdownCard` shape for shape.
class InvoiceFinancialBreakdownCard extends StatelessWidget {
  const InvoiceFinancialBreakdownCard({super.key, required this.request});
