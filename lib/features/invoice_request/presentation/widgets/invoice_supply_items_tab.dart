...
/// Financial Breakdown card shown on Summary. Mirrors
/// `GrnSupplyItemsTab` shape for shape.
class InvoiceSupplyItemsTab extends StatelessWidget {
  const InvoiceSupplyItemsTab({super.key, required this.request});
